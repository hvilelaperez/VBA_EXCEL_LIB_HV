# Función de Orden de Caracteres String

Genera secuencias de caracteres alfabéticos (como columnas de Excel) a partir de un número.
...
| Función | Descripción |
|---------|-------------|
| `OrderChar$` | Convierte número a secuencia de caracteres (1=A, 27=AA) |
| `LocalOrder&` | Convierte cadena alfabética a número |
| `reCapCol` | Obtiene la dirección de columna por número |
| Límite | 16384 columnas (Excel 2016+) |

---

*Módulo: 31_CodigosGenerales | Archivo: 23_FuncionNumerosString.md*
